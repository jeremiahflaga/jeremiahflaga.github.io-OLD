...
Working Effectively with Legacy Code (only the first six chapters for now, and chapter 16)

Clean Architecture (Rough Cuts - September 2016) - using Safari Books Online

- You can also learn the things presented here in Uncle Bob's blog posts and talks on Clean Architecture. But a book is more structured, of course.
...
Bitcoin book by Steve Patterson
...
- Bad for young Christians to read, I think.
