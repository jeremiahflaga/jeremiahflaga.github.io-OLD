...
But most software systems in existence today are in the _maintenance phase_. And I've seen systems in the maintenance phase whose codebase is very messy. It's so hard to work on such codebases, especially when you are just a beginner programmer. And in the beginning of my career as a programmer, I was amazed that production code can be messy too. I even thought to myself during that time that _I will never work on any messy codebase again_.
